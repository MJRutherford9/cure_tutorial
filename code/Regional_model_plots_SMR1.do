*** Regional Model Plots with SMR=1 ***

* See "Regional_analysis_SMR1.do" for fitting of models

*** Curves ***

use ".\data\regional_models_for_plots_SMR1.dta", clear

stset OS_mm if dataset==0, failure(dead) id(id) scale(12)

*** Model 6 didn't converge with 5df, so reduced to 4. Model 12 didn't converge with 5df and 3df, had to reduce to 4 and 2. Have relabeled graphs below.
...
sts graph, ci plotopts(lwidth(medium) lpattern(dash))  /// 
									...
									(line S1_m7 tplot_m7, sort lcolor(olive) lwidth(thin)) ///
									(line S1_m8 tplot_m8, sort lcolor(magenta) lwidth(thin)) ///
		...
		7 "Non-mixture cure model, df3, 15y BK" 8 "Non-mixture cure model, df4, 15y BK" 9 "Mixture cure model (log-normal), age" 10 "Mixture cure model (Weibull), age" ///
		11 "Non-mixture cure model, df3, 5y BK, age" 12 "Non-mixture cure model, df5, 5y BK, age" 13 "Non-mixture cure model, df3, 15y BK, age" ///
		14 "Non-mixture cure model, df4, 15y BK, age" 15 "FPM non-cure, df4" ///
        ...
        graphregion(color(white)) plotregion(fcolor(white)) name(Regional_Surv50_SMR1_24m, replace)
...
sts graph, hazard ci plotopts(lwidth(medium) lpattern(dash)) /// 
									...
									(line H1_m7 tplot_m7, sort lcolor(olive) lwidth(thin)) ///
									(line H1_m8 tplot_m8, sort lcolor(magenta) lwidth(thin)) ///
		...
		4 "Mixture cure model (Weibull)" 5 "Non-mixture cure model, df3, 5y BK" 6 "Non-mixture cure model, df4, 5y BK" ///
		7 "Non-mixture cure model, df3, 15y BK" 8 "Non-mixture cure model, df4, 15y BK" 9 "Mixture cure model (log-normal), age" 10 "Mixture cure model (Weibull), age" ///
		11 "Non-mixture cure model, df3, 5y BK, age" 12 "Non-mixture cure model, df4, 5y BK, age" 13 "Non-mixture cure model, df3, 15y BK, age" ///
		14 "Non-mixture cure model, df4, 15y BK, age" 15 "FPM non-cure, df4" ///
		16 "Expected survival background population") size(vsmall)) xscale(range(0 50)) xlabel(0(5)50)) ///
		...
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Regional_Haz50_SMR1_24m, replace )
...
sts graph, ci plotopts(lwidth(medium) lpattern(dash))  /// 
									...
									(line S1_m7 tplot_m7 if tplot_m7<20, sort lcolor(olive) lwidth(thin)) ///
									(line S1_m8 tplot_m8 if tplot_m8<20, sort lcolor(magenta) lwidth(thin)) ///
        ...
        ylabel(#8, labsize(small) angle(horizontal) format(%9.2f) nogrid) yscale(range(0 1.0)) ///
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Regional_Surv20_SMR1_24m, replace)
...
sts graph, hazard ci plotopts(lwidth(medium) lpattern(dash)) /// 
									...
									(line H1_m7 tplot_m7 if tplot_m7<20, sort lcolor(olive) lwidth(thin)) ///
									(line H1_m8 tplot_m8 if tplot_m8<20, sort lcolor(magenta) lwidth(thin)) ///
        ...
        ylabel(#10, labsize(small) angle(horizontal) format(%9.2f) nogrid) yscale(range(0 1.0)) ///
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Regional_Haz20_SMR1_24m, replace)
...
sts graph, ci plotopts(lwidth(medium) lpattern(dash))  /// 
									ciopts(recast(rarea) fcolor(midblue%40) fintensity(40) lcolor(none%0)) ///
									addplot((line S1_m7 tplot_m7 if tplot_m7<20, sort lcolor(olive) lwidth(thin)) ///
									(line S1_m8 tplot_m8 if tplot_m8<20, sort lcolor(magenta) lwidth(thin)) ///
        ...
        ylabel(#8, labsize(small) angle(horizontal) format(%9.2f) nogrid) yscale(range(0 1.0)) ///
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Regional_Surv20_SMR1_24m_paper,replace)



sts graph, hazard ci plotopts(lwidth(medium) lpattern(dash)) /// 
									ciopts(recast(rarea) fcolor(midblue%40) fintensity(40) lcolor(none%0)) ///
									addplot((line H1_m7 tplot_m7 if tplot_m7<20, sort lcolor(olive) lwidth(thin)) ///
									(line H1_m8 tplot_m8 if tplot_m8<20, sort lcolor(magenta) lwidth(thin)) ///
		...
		7 "Expected survival background population") size(vsmall)) xscale(range(0 20)) xlabel(0(2)20)) ///
		legend(pos(2) ring(0) cols(2)) title("", size(zero) nobox) ytitle(Hazard) ytitle(, size(small)) ///
        ylabel(#10, labsize(small) angle(horizontal) format(%9.2f) nogrid) yscale(range(0 0.4)) ///
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Regional_Haz20_SMR1_24m_paper, replace)
...
sts graph, ci plotopts(lwidth(medium) lpattern(dash))  /// 
									...
									(line S1_m26 t_exp50_24, sort lcolor(green) lwidth(thin)) /// 
									(line expsurv50_b t_exp50_b, sort lpattern(dot) lcolor(black)), below ///
        ...
        ylabel(#8, labsize(small) angle(horizontal) format(%9.2f) nogrid) yscale(range(0 1.0)) ///
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Regional_Surv50_SMR1_48m,replace)
...
sts graph, hazard ci plotopts(lwidth(medium) lpattern(dash)) /// 
									...
									(line H1_m26 t_exp50_24, sort lcolor(green) lwidth(thin)) /// 
									(line exphaz50_b t_exp50_b, sort lpattern(dot) lcolor(black)), below ///
        ...
        ylabel(#10, labsize(small) angle(horizontal) format(%9.2f) nogrid) yscale(range(0 1.0)) ///
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Regional_Haz50_SMR1_48m,replace)
...
sts graph, ci plotopts(lwidth(medium) lpattern(dash))  /// 
									...
									(line S1_m26 t_exp50_24 if t_exp50_24<20, sort lcolor(green) lwidth(thin)) /// 
									(line expsurv50_b t_exp50_b if t_exp50_b<20, sort lpattern(dot) lcolor(black)), below ///
									legend(order(2 "Kaplan-Meier" 3 "Mixture cure model (log-normal)" 4 "Mixture cure model (Weibull)" ///
		5 "Non-mixture cure model, df3, 5y BK" 6 "Non-mixture cure model, df5, 5y BK" ///
		7 "Non-mixture cure model, df3, 15y BK" 8 "Non-mixture cure model, df5, 15y BK" 9 "Mixture cure model (log-normal), age" 10 "Mixture cure model (Weibull), age" ///
        ...
        ylabel(#8, labsize(small) angle(horizontal) format(%9.2f) nogrid) yscale(range(0 1.0)) ///
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Regional_Surv20_SMR1_48m,replace)
...
sts graph, hazard ci plotopts(lwidth(medium) lpattern(dash)) /// 
									...
									(line H1_m26 t_exp50_24 if t_exp50_24<20, sort lcolor(green) lwidth(thin)) /// 
									(line exphaz50_b t_exp50_b if t_exp50_b<20, sort lpattern(dot) lcolor(black)), below ///
									legend(order(2 "Observed smoothed hazard" 3 "Mixture cure model (log-normal)" 4 "Mixture cure model (Weibull)" ///
		5 "Non-mixture cure model, df3, 5y BK" 6 "Non-mixture cure model, df5, 5y BK" ///
		7 "Non-mixture cure model, df3, 15y BK" 8 "Non-mixture cure model, df5, 15y BK" 9 "Mixture cure model (log-normal), age" 10 "Mixture cure model (Weibull), age" ///
        ...
        ylabel(#10, labsize(small) angle(horizontal) format(%9.2f) nogrid) yscale(range(0 1.0)) ///
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Regional_Haz20_SMR1_48m,replace)
...
sts graph, ci plotopts(lwidth(medium) lpattern(dash))  /// 
									...
									(line S1_m21 tplot_m21 if tplot_m21<20, sort lcolor(magenta) lwidth(thin)) ///
									(line surv_m22 tt if tt<20, sort lcolor(orange) lwidth(thin)) /// 
									(line surv_m24 tt if tt<20, sort lcolor(red) lwidth(thin)) ///
									(line expsurv50_b t_exp50_b if t_exp50_b<20, sort lpattern(dot) lcolor(black)), below ///
									legend(order(2 "Kaplan-Meier" 3 "Mixture cure model (log-normal), age" 4 "Mixture cure model (Weibull), age" ///
		5 "Non-mixture cure model, 2 knot, 5y bk, age" 6 "Non-mixture cure model, 2 knot, 15y bk, age" ///
		7 "Expected survival background population") size(vsmall)) xscale(range(0 20)) xlabel(0(2)20)) ///
        ...
        ylabel(#8, labsize(small) angle(horizontal) format(%9.2f) nogrid) yscale(range(0 1.0)) ///
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Regional_Surv20_SMR1_48m_paper,replace)
...
sts graph, hazard ci plotopts(lwidth(medium) lpattern(dash)) /// 
									...
									(line H1_m21 tplot_m21 if tplot_m21<20, sort lcolor(magenta) lwidth(thin)) ///
									(line haz_m22 tt if tt<20, sort lcolor(orange) lwidth(thin)) ///
									(line haz_m24 tt if tt<20, sort lcolor(red) lwidth(thin)) ///
									(line exphaz50_b t_exp50_b if t_exp50_b<20, sort lpattern(dot) lcolor(black)), below ///
									legend(order(2 "Observed smoothed hazard" 3 "Mixture cure model (log-normal), age" 4 "Mixture cure model (Weibull), age" ///
		5 "Non-mixture cure model, 2 knot, 5y bk, age" 6 "Non-mixture cure model, 2 knot, 15y bk, age" ///
		7 "Expected survival background population") size(vsmall)) xscale(range(0 20)) xlabel(0(2)20)) ///
        ...
        ylabel(#10, labsize(small) angle(horizontal) format(%9.2f) nogrid) yscale(range(0 0.4)) ///
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Regional_Haz20_SMR1_48m_paper,replace)
