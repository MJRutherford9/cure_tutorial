*** Distant Model Plots with SMR=1 ***

* See "Distant_analysis_SMR1.do" for fitting of models

*** Curves ***

use "..\data\distant_models_for_plots_SMR1.dta", clear
...
sts graph, ci plotopts(lwidth(medium) lpattern(dash))  /// 
		...
		14 "Non-mixture cure model, df5, 15y BK, age" 15 "FPM non-cure, df4" ///
        ...
        graphregion(color(white)) plotregion(fcolor(white)) name(Distant_Surv50_SMR1_24m,replace)
...
sts graph, hazard ci plotopts(lwidth(medium) lpattern(dash)) /// 
		...
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Distant_Haz50_SMR1_24m, replace)
...
sts graph, ci plotopts(lwidth(medium) lpattern(dash))  /// 
        ...
        ylabel(#8, labsize(small) angle(horizontal) format(%9.2f) nogrid) yscale(range(0 1.0)) ///
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Distant_Surv20_SMR1_24m,replace)
...
sts graph, hazard ci plotopts(lwidth(medium) lpattern(dash)) /// 
        ...
        ylabel(#10, labsize(small) angle(horizontal) format(%9.2f) nogrid) yscale(range(0 1.0)) ///
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Distant_Haz20_SMR1_24m, replace)
...
sts graph, ci plotopts(lwidth(medium) lpattern(dash))  /// 
        ...
        ylabel(#8, labsize(small) angle(horizontal) format(%9.2f) nogrid) yscale(range(0 1.0)) ///
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Distant_Surv20_SMR1_24m_paper,replace)
...
sts graph, hazard ci plotopts(lwidth(medium) lpattern(dash)) /// 
		...
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Distant_Haz20_SMR1_24m_paper, replace)
=
...
sts graph, ci plotopts(lwidth(medium) lpattern(dash))  /// 
        ...
        ylabel(#8, labsize(small) angle(horizontal) format(%9.2f) nogrid) yscale(range(0 1.0)) ///
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Distant_Surv50_SMR1_48m,replace)
...
sts graph, hazard ci plotopts(lwidth(medium) lpattern(dash)) /// 
        ...
        ylabel(#10, labsize(small) angle(horizontal) format(%9.2f) nogrid) yscale(range(0 1.0)) ///
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Distant_Haz50_SMR1_48m,replace)
...
sts graph, ci plotopts(lwidth(medium) lpattern(dash))  /// 
        ...
        ylabel(#8, labsize(small) angle(horizontal) format(%9.2f) nogrid) yscale(range(0 1.0)) ///
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Distant_Surv20_SMR1_48m,replace)
...
sts graph, hazard ci plotopts(lwidth(medium) lpattern(dash)) /// 
        ...
        ylabel(#10, labsize(small) angle(horizontal) format(%9.2f) nogrid) yscale(range(0 1.0)) ///
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Distant_Haz20_SMR1_48m,replace)
...
sts graph, ci plotopts(lwidth(medium) lpattern(dash))  /// 
        ...
        ylabel(#8, labsize(small) angle(horizontal) format(%9.2f) nogrid) yscale(range(0 1.0)) ///
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Distant_Surv20_SMR1_48m_paper,replace)
...
sts graph, hazard ci plotopts(lwidth(medium) lpattern(dash)) /// 
        ...
        ylabel(#10, labsize(small) angle(horizontal) format(%9.2f) nogrid) yscale(range(0 2.0)) ///
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Distant_Haz20_SMR1_48m_paper,replace)
