*** Distant (no cure) Model Plots with SMR=2.5 ***

* See "Distant_nocure_analysis_SMR25.do" for fitting of models

*** Curves ***

use "..\data\distant_nocure_models_for_plots_SMR25.dta", clear
...
sts graph, ci plotopts(lwidth(medium) lpattern(dash))  /// 
        ...
        graphregion(color(white)) plotregion(fcolor(white)) name(Distant_nocure_Surv50_SMR25_24m,replace)
...
sts graph, hazard ci plotopts(lwidth(medium) lpattern(dash)) /// 
		...
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Distant_nocure_Haz50_SMR25_24m,replace)
...
sts graph, ci plotopts(lwidth(medium) lpattern(dash))  /// 
        ...
        ylabel(#8, labsize(small) angle(horizontal) format(%9.2f) nogrid) yscale(range(0 1.0)) ///
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Distant_nocure_Surv20_SMR25_24m,replace)
...
sts graph, hazard ci plotopts(lwidth(medium) lpattern(dash)) /// 
        ...
        ylabel(#10, labsize(small) angle(horizontal) format(%9.2f) nogrid) yscale(range(0 1.0)) ///
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Distant_nocure_Haz20_SMR25_24m,replace)
...
sts graph, ci plotopts(lwidth(medium) lpattern(dash))  /// 
        ...
        ylabel(#8, labsize(small) angle(horizontal) format(%9.2f) nogrid) yscale(range(0 1.0)) ///
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Distant_nocure_Surv50_SMR25_48m,replace)
...
sts graph, hazard ci plotopts(lwidth(medium) lpattern(dash)) /// 
        ...
        ylabel(#10, labsize(small) angle(horizontal) format(%9.2f) nogrid) yscale(range(0 1.0)) ///
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Distant_nocure_Haz50_SMR25_48m,replace)
...
sts graph, ci plotopts(lwidth(medium) lpattern(dash))  /// 
        ...
        ylabel(#8, labsize(small) angle(horizontal) format(%9.2f) nogrid) yscale(range(0 1.0)) ///
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Distant_nocure_Surv20_SMR25_48m,replace)
...
sts graph, hazard ci plotopts(lwidth(medium) lpattern(dash)) /// 
        ...
        ylabel(#10, labsize(small) angle(horizontal) format(%9.2f) nogrid) yscale(range(0 1.0)) ///
		xtitle(Time since randomisation (years)) xtitle(, size(small)) xlabel(, labsize(small)) /// 
        graphregion(color(white)) plotregion(fcolor(white)) name(Distant_nocure_Haz20_SMR25_48m,replace)
